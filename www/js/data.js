/*
pulled from: https://github.com/Ashenfactory/nuzlocke-tracker/blob/master/js/main.js
*/
var locations = {
  "rgby": {
    "id": "rgby",
    "title": "Red, Green, Blue and Yellow",
    "nameLimit": 10,
    "dexLimit": 151,
    "locations": [
      "Starter",
...
var games = {
  "Red": {"locations": "rgby"},
  "Green": {"locations": "rgby"},
  "Blue": {"locations": "rgby"},
  "Yellow": {"locations": "rgby"},
  "Gold": {"locations": "gsc"},
  "Silver": {"locations": "gsc"},
  "Crystal": {"locations": "gsc"},
  "Ruby": {"locations": "rse"},
  "Sapphire": {"locations": "rse"},
  "Emerald": {"locations": "rse"},
  "FireRed": {"locations": "frlg"},
  "LeafGreen": {"locations": "frlg"},
}

/*
pulled from: https://pokemondb.net/pokedex/national

pokemon = {};
[...document.getElementsByClassName('infocard-lg-data')].forEach((el)=>{
  var name = el.getElementsByClassName('ent-name')[0].innerHTML,
    dex  = +el.getElementsByTagName('small')[0].innerHTML.substring(1,4);
  pokemon[name] = dex;
  pokemon[dex] = name;
});
